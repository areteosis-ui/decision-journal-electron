...
const MIGRATIONS: Migration[] = [
  ...
  },
  {
    version: 3,
    sql: `
      ALTER TABLE decisions ADD COLUMN outcome_rating    TEXT;
      ALTER TABLE decisions ADD COLUMN decision_quality  TEXT;
      ALTER TABLE decisions ADD COLUMN calibration_note  TEXT NOT NULL DEFAULT '';
    `
  }
]
